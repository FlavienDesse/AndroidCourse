package com.lesbougs.androidcourse.utils;
...
public class PreferenceUtils {
    ...
    private static SharedPreferences getSharedPreferences(){
        return TwitterApplication.getContext().getSharedPreferences(Constants.Preferences.SHARED_PREFERENCES_FILE_NAME, Context.MODE_PRIVATE);
    }
